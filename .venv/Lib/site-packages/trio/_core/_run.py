...
def _hypothesis_plugin_setup() -> None:
    ...
    _ALLOW_DETERMINISTIC_SCHEDULING = True
    register_random(_r)
...
class Task(metaclass=NoPublicConstructor):
    ...
    coro: types.CoroutineType[Any, Outcome[object], Any]
    _runner: Runner
    name: str
...
class Runner:
    ...
    _locals: dict[_core.RunVar[Any], object] = attrs.Factory(dict)
