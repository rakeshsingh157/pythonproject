...
class AbstractPayloadDecoder(object):
    ...
    def valueDecoder(self, substrate, asn1Spec,
        ...
        """
        raise error.PyAsn1Error('SingleItemDecoder not implemented for %s' % (tagSet,))
...
TAG_MAP = {
    ...
    univ.Set.tagSet: SetOrSetOfPayloadDecoder(),
    univ.Choice.tagSet: ChoicePayloadDecoder(),
    ...
    def __call__(self, substrate, asn1Spec=None,
        ...
        while state is not stStop:
            ...
            if state is stDecodeValue:
                if not options.get('recursiveFlag', True) and not substrateFun:
