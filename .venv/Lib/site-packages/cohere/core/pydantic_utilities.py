...
class UniversalBaseModel(pydantic.BaseModel):
    if IS_PYDANTIC_V2:
        ...
        def serialize_model(self, handler: pydantic.SerializerFunctionWrapHandler) -> Any:
...
def universal_root_validator(
    ...
    def decorator(func: AnyCallable) -> AnyCallable:
        if IS_PYDANTIC_V2:
            return cast(AnyCallable, pydantic.model_validator(mode="before" if pre else "after")(func))
