                            ...
                            for _text in _response.iter_lines():
                                try:
                                    ...
                                    yield typing.cast(
                                        ...
                                        construct_type(
                                            type_=GenerateStreamedResponse,
                                            object_=json.loads(_text),
                                        ),
                                    )
                                except Exception:
