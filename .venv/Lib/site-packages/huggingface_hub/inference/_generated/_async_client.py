...
class AsyncInferenceClient:
        ...
        with _open_as_binary(request_parameters.data) as data_as_binary:
            ...
            try:
                ...
                if response.status != 200:
                    try:
                        response_error_payload = await response.json()
                    except Exception:
                        pass
                ...
                raise InferenceTimeoutError(f"Inference call timed out: {request_parameters.url}") from error
    ...
    async def chat_completion(
        ...
        *,
        ...
        if stream:
            return _async_stream_chat_completion_response(data)
    ...
    async def text_classification(
        ...
        *,
        ...
        response = await self._inner_post(request_parameters)
        return TextClassificationOutputElement.parse_obj_as_list(response)[0]
    @overload
    ...
    async def text_generation(
        ...
        *,
        ...
        if stream:
            return _async_stream_text_generation_response(bytes_output, details)
