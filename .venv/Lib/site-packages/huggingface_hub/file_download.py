...
from .utils._runtime import _PY_VERSION, is_xet_available
...
def get_hf_file_metadata(
    ...
    hf_headers["Accept-Encoding"] = "identity"
    ...
    return HfFileMetadata(
        ...
        xet_file_data=parse_xet_file_data_from_response(r, endpoint=endpoint),
    )
def _get_metadata_or_catch_error(
    *,
    ...
    return (url_to_download, etag, commit_hash, expected_size, xet_file_data, head_error_call)
