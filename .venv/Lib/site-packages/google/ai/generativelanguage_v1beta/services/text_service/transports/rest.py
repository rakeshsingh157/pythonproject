...
class TextServiceRestTransport(_BaseTextServiceRestTransport):
    ...
    def batch_embed_text(
        ...
        return self._BatchEmbedText(self._session, self._host, self._interceptor)
    @property
    def count_text_tokens(
        ...
        return self._CountTextTokens(self._session, self._host, self._interceptor)
    @property
    def embed_text(
        self,
    ) -> Callable[[text_service.EmbedTextRequest], text_service.EmbedTextResponse]:

        return self._EmbedText(self._session, self._host, self._interceptor)
    @property
    def generate_text(
        self,
    ) -> Callable[
        ...
        return self._GenerateText(self._session, self._host, self._interceptor)
    @property
