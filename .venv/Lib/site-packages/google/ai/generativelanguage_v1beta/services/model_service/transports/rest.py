...
class ModelServiceRestTransport(_BaseModelServiceRestTransport):
    ...
    def create_tuned_model(
        ...
        return self._CreateTunedModel(self._session, self._host, self._interceptor)
    @property
    def delete_tuned_model(
        self,
    ) -> Callable[[model_service.DeleteTunedModelRequest], empty_pb2.Empty]:

        return self._DeleteTunedModel(self._session, self._host, self._interceptor)
    @property
    def get_model(self) -> Callable[[model_service.GetModelRequest], model.Model]:

        return self._GetModel(self._session, self._host, self._interceptor)
    @property
    def get_tuned_model(
        self,
    ) -> Callable[[model_service.GetTunedModelRequest], tuned_model.TunedModel]:

        return self._GetTunedModel(self._session, self._host, self._interceptor)
    @property
    def list_models(
        self,
    ) -> Callable[[model_service.ListModelsRequest], model_service.ListModelsResponse]:

        return self._ListModels(self._session, self._host, self._interceptor)
    @property
    def list_tuned_models(
        ...
        return self._ListTunedModels(self._session, self._host, self._interceptor)
    @property
    def update_tuned_model(
        self,
    ) -> Callable[[model_service.UpdateTunedModelRequest], gag_tuned_model.TunedModel]:

        return self._UpdateTunedModel(self._session, self._host, self._interceptor)
    @property
