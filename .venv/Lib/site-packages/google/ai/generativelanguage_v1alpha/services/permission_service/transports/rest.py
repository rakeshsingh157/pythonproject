...
class PermissionServiceRestTransport(_BasePermissionServiceRestTransport):
    ...
    def create_permission(
        ...
        return self._CreatePermission(self._session, self._host, self._interceptor)
    @property
    def delete_permission(
        self,
    ) -> Callable[[permission_service.DeletePermissionRequest], empty_pb2.Empty]:

        return self._DeletePermission(self._session, self._host, self._interceptor)
    @property
    def get_permission(
        self,
    ) -> Callable[[permission_service.GetPermissionRequest], permission.Permission]:

        return self._GetPermission(self._session, self._host, self._interceptor)
    @property
    def list_permissions(
        ...
        return self._ListPermissions(self._session, self._host, self._interceptor)
    @property
    def transfer_ownership(
        ...
        return self._TransferOwnership(self._session, self._host, self._interceptor)
    @property
    def update_permission(
        ...
        return self._UpdatePermission(self._session, self._host, self._interceptor)
    @property
