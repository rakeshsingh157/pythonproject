...
class RetrieverServiceRestTransport(_BaseRetrieverServiceRestTransport):
    ...
    def batch_create_chunks(
        ...
        return self._BatchCreateChunks(self._session, self._host, self._interceptor)
    @property
    def batch_delete_chunks(
        self,
    ) -> Callable[[retriever_service.BatchDeleteChunksRequest], empty_pb2.Empty]:

        return self._BatchDeleteChunks(self._session, self._host, self._interceptor)
    @property
    def batch_update_chunks(
        ...
        return self._BatchUpdateChunks(self._session, self._host, self._interceptor)
    @property
    def create_chunk(
        self,
    ) -> Callable[[retriever_service.CreateChunkRequest], retriever.Chunk]:

        return self._CreateChunk(self._session, self._host, self._interceptor)
    @property
    def create_corpus(
        self,
    ) -> Callable[[retriever_service.CreateCorpusRequest], retriever.Corpus]:

        return self._CreateCorpus(self._session, self._host, self._interceptor)
    @property
    def create_document(
        self,
    ) -> Callable[[retriever_service.CreateDocumentRequest], retriever.Document]:

        return self._CreateDocument(self._session, self._host, self._interceptor)
    @property
    def delete_chunk(
        self,
    ) -> Callable[[retriever_service.DeleteChunkRequest], empty_pb2.Empty]:

        return self._DeleteChunk(self._session, self._host, self._interceptor)
    @property
    def delete_corpus(
        self,
    ) -> Callable[[retriever_service.DeleteCorpusRequest], empty_pb2.Empty]:

        return self._DeleteCorpus(self._session, self._host, self._interceptor)
    @property
    def delete_document(
        self,
    ) -> Callable[[retriever_service.DeleteDocumentRequest], empty_pb2.Empty]:

        return self._DeleteDocument(self._session, self._host, self._interceptor)
    @property
    def get_chunk(
        self,
    ) -> Callable[[retriever_service.GetChunkRequest], retriever.Chunk]:

        return self._GetChunk(self._session, self._host, self._interceptor)
    @property
    def get_corpus(
        self,
    ) -> Callable[[retriever_service.GetCorpusRequest], retriever.Corpus]:

        return self._GetCorpus(self._session, self._host, self._interceptor)
    @property
    def get_document(
        self,
    ) -> Callable[[retriever_service.GetDocumentRequest], retriever.Document]:

        return self._GetDocument(self._session, self._host, self._interceptor)
    @property
    def list_chunks(
        self,
    ) -> Callable[
        ...
        return self._ListChunks(self._session, self._host, self._interceptor)
    @property
    def list_corpora(
        self,
    ) -> Callable[
        ...
        return self._ListCorpora(self._session, self._host, self._interceptor)
    @property
    def list_documents(
        self,
    ) -> Callable[
        ...
        return self._ListDocuments(self._session, self._host, self._interceptor)
    @property
    def query_corpus(
        self,
    ) -> Callable[
        ...
        return self._QueryCorpus(self._session, self._host, self._interceptor)
    @property
    def query_document(
        self,
    ) -> Callable[
        ...
        return self._QueryDocument(self._session, self._host, self._interceptor)
    @property
    def update_chunk(
        self,
    ) -> Callable[[retriever_service.UpdateChunkRequest], retriever.Chunk]:

        return self._UpdateChunk(self._session, self._host, self._interceptor)
    @property
    def update_corpus(
        self,
    ) -> Callable[[retriever_service.UpdateCorpusRequest], retriever.Corpus]:

        return self._UpdateCorpus(self._session, self._host, self._interceptor)
    @property
    def update_document(
        self,
    ) -> Callable[[retriever_service.UpdateDocumentRequest], retriever.Document]:

        return self._UpdateDocument(self._session, self._host, self._interceptor)
    @property
