...
class GenerativeServiceRestTransport(_BaseGenerativeServiceRestTransport):
    ...
    def batch_embed_contents(
        ...
        return self._BatchEmbedContents(self._session, self._host, self._interceptor)
    @property
    def bidi_generate_content(
        ...
        return self._BidiGenerateContent(self._session, self._host, self._interceptor)
    @property
    def count_tokens(
        self,
    ) -> Callable[
    ...
    def embed_content(
        ...
        return self._EmbedContent(self._session, self._host, self._interceptor)
    @property
    def generate_answer(
        self,
    ) -> Callable[
        ...
        return self._GenerateAnswer(self._session, self._host, self._interceptor)
    @property
