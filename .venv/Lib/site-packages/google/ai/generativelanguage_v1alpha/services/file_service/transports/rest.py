...
class FileServiceRestTransport(_BaseFileServiceRestTransport):
    ...
    def create_file(
        ...
        return self._CreateFile(self._session, self._host, self._interceptor)
    @property
    def delete_file(
        self,
    ) -> Callable[[file_service.DeleteFileRequest], empty_pb2.Empty]:

        return self._DeleteFile(self._session, self._host, self._interceptor)
    @property
    def get_file(self) -> Callable[[file_service.GetFileRequest], file.File]:

        return self._GetFile(self._session, self._host, self._interceptor)
    @property
    def list_files(
        self,
    ) -> Callable[[file_service.ListFilesRequest], file_service.ListFilesResponse]:

        return self._ListFiles(self._session, self._host, self._interceptor)
    @property
