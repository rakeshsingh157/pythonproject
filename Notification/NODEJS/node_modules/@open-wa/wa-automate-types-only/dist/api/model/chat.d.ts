import { ContactId, GroupChatId } from '@open-wa/wa-automate-types-only/dist/api/model/aliases';
import { Contact } from '@open-wa/wa-automate-types-only/dist/api/model/contact';
import { GroupMetadata } from '@open-wa/wa-automate-types-only/dist/api/model/group-metadata';
