...
import { Chat, ChatId, Message, MessageId } from '@open-wa/wa-automate-types-only/dist/api/model';
import { SimpleListener } from '@open-wa/wa-automate-types-only/dist/api/model/events';
import { Collector, CollectorOptions } from '@open-wa/wa-automate-types-only/dist/structures/Collector';
/**
