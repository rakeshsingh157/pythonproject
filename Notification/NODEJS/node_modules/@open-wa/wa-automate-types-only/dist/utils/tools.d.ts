...
/// <reference types="node" />
/// <reference types="node" />
import { AdvancedFile, ConfigObject, DataURL } from '@open-wa/wa-automate-types-only/dist/api/model';
import { AxiosRequestConfig } from 'axios';
import { SessionInfo } from '@open-wa/wa-automate-types-only/dist/api/model/sessionInfo';
